...
ML in R Certification Course/ – Main working directory with daily folders, R scripts, and notebooks that follow the course lessons and practice activities.
​
...
Data manipulation with dplyr and tidyr, and data visualization in R.
​

Supervised learning in R: linear regression, logistic regression, decision trees, random forests, and support vector machines.
​
...
Days 4–5: Functions in R, data manipulation with dplyr and tidyr, and basic visualization.

Days 6–8: Machine learning fundamentals, problem framing, and exploratory data analysis.
​
...
Days 18–19: Time series analysis in R: decomposition, basic forecasting ideas.
​
​

Day 20: Mini‑project that combines data cleaning, modeling, and visualization into a single end‑to‑end workflow.

Create a markdown note for each day (for example Day01.md) to log what was learned, links to scripts, and reflections or next steps.
